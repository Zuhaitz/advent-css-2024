<template>
  <section>
    ...
    <section>
      ...
      <article>
        <img
          src="./images/trump-tomlinson-split.jpg"
          alt="‘Honeymoon is over’: GOP strategist on what shutdown drama may mean for Trump"
        />
        <h1>
          ‘Honeymoon is over’: GOP strategist on what shutdown drama may mean
          for Trump
        </h1>
      </article>
    </section>
    ...
    <section>
      <article>
        <img
          src="./images/christmas-market.jpg"
          alt="Saudi Arabia warned Germany three times about market attack suspect, source says"
        />
        <h1>
          Saudi Arabia warned Germany three times about market attack suspect,
          source says
        </h1>
      </article>
      ...
      <article>
        ...
        />
        <h1>
          Durbin uses new report to accuse Justices Thomas and Alito of
    ...
    <section>
      ...
      <article>
        <img
          src="./images/brain-rot.jpg"
          alt="‘Brain rot’ is increasingly common. Dr. Sanjay Gupta explains how to combat it"
        />
        <h1>
          ‘Brain rot’ is increasingly common. Dr. Sanjay Gupta explains how to
          combat it
        </h1>
      </article>
      ...
      <article>
        <img
          src="./images/injuries.jpg"
          alt="An estimated 16,000 people go to the hospital for holiday decor-related injuries each year"
        />
        <h1>
          An estimated 16,000 people go to the hospital for holiday
          decor-related injuries each year
        </h1>
      </article>
    </section>
  </section>
